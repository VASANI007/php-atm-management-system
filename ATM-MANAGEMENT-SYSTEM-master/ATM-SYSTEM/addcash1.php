...
<html>
    ...
    <div class="header">
        <div class="inner-header">
            <div class="logo">
                <p><center>AsiaBank ATM</center></p>
            </div>
        </div>
    </div>
    <div class="container" style= "box-shadow: inset 0 8px 5px #ea2f00">
        <div class="banner-image">
            <div class="inner-banner-image">
                <b><h4>Transaction Successful</h4></b>
            </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-4 col-lg-offset-4">
                <br><Br><a href="index.php" style= "box-shadow: inset 0 8px 5px #22a4c8" class="button">Exit</a> <br> &emsp;</center>
            </div>
        </div>
        </div>
    </body>
