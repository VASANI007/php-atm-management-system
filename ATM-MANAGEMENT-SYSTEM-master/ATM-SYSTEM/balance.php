...
session_start();
$pin=$_SESSION['Pin'];
$select_query="select a.first_name,a.last_name, b.account_number ,b.account_type,c.balance
...
<html>
    ...
    <div class="header">
        <div class="inner-header">
            <div class="logo">
                <p><center>AsiaBank ATM</center><br><br><br> <br><br><br></p>
            </div>
        </div>
    </div>
    <div class="container" style= "box-shadow: inset 0 8px 5px #ea2f00">
        <div class="row">
            <h7><br><Br><Br><b><div class="col-xs-2">Name: </div>
                <div class="col-xs-10"><?php echo $row['first_name']; echo(" "); echo $row['last_name'] ?> </div><br><br></b></h7>
        </div>
        <div class="row">
        ...
        <h7><b><div class="col-xs-2">Account Type: </div>
                <div class="col-xs-7"><?php echo $row["account_type"]; ?></div></b><br><br></h7>
        </div>
        <div class="row">
            <h7><b><div class="col-xs-2">Available Balanace:  </div>
                <div class="col-xs-10"><?php echo $row['balance'] ?></div></b><br><br></h7><br>
        </div>
        <a href="index.php" class="button" style= "box-shadow: inset 0 8px 5px #22a4c8" a>Exit</a></center>
    </body>
</html>
