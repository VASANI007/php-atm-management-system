...
<div class="container" style= "box-shadow: inset 0 8px 5px #ea2f00">
        ...
        <table>
            <tbody>
            <th><h1>
                    <br><Br><BR><center>Please select the type of account</center><br><br><br><br>
                </h1>
            </th>
                <tr>
                    <td>
                        <a href="savings.php" class="button" style= "box-shadow: inset 0 8px 5px #22a4c8">Savings</a> <br><br><br>
                    </td>
                    <td>
                        <a href="current1.php" class="button" style= "box-shadow: inset 0 8px 5px #22a4c8">Current</a><br><br><br> &emsp;
                    </td>
                </tr>
        </tbody>
        </table>
