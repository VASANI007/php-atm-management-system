...
<div class="container" style= "box-shadow: inset 0 8px 5px #ea2f00">
    ...
    <div class="row">
        ...
        <table>
            <tbody>
            <th><h1>
                        Admin Options<br><br></center></th>
                </h1>
            </th>
                <tr>
                    <td>
                        <a href="addcash.php" class="button" style= "box-shadow: inset 0 8px 5px #22a4c8">Add cash</a> <br><br><br> &emsp; 
                    </td>
                    <td>
                        <a href="summary.php" class="button" style= "box-shadow: inset 0 8px 5px #22a4c8">Transaction Summary</a><br><br><br> &emsp;
                    </td>
                </tr>
